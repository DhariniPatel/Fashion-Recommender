...
@WebServlet("/CompanyManagecategoryController")
public class CompanyManagecategoryController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public CompanyManagecategoryController() {
        super();
	...
	private void update(HttpServletRequest request, HttpServletResponse response) throws IOException 
	{
		...
		managecategoryVO.setCategoryId(categoryId);
		response.sendRedirect("company/searchManagecategoryUpdate.jsp");
	...
	
	{
		...
		response.sendRedirect("company/searchManagecategory.jsp");
	}
	...
	private void insert(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		response.sendRedirect("company/addManagecategory.jsp");

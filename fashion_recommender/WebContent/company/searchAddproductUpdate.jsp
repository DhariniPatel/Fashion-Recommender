...
z-index: 999999">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <c:forEach items="${sessionScope.productlist}" var="i" >
                                        <form action="<%=request.getContextPath() %>/AddproductController" method="post" class="form-horizontal  login_validator" id="form_block_validator">
                                                	<input type="hidden" name="flag" value="finalupdate">
 ...
 -->                                                    	<select name="subcategoryId" class="form-control">
 															<c:forEach items="${sessionScope.subcategorylist}" var="k">						
                                                    		<option value="${k.subcategoryId}">${k.subcategoryName}</option>
     														</c:forEach>
                                                    		</select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="productName" value="${i.productName}" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4  text-lg-right">
                                                    <label for="required2" class="form-control-label">Product Size</label>
                                                </div>
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="productSize" value="${i.productSize}" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="file" id="required2" name="file" value="{i.filePath}" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="productPrice" value="${i.productPrice}" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="productQuantity" value="${i.productQuantity}" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="productDescription" class="form-control">${i.productDescription}</textarea>
                                                </div>
                                            </div>

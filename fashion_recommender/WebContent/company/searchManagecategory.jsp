                            ...
                            <div class="col-xs-12 data_tables">
                                ...
                                <div class="card">
                                    <div class="card-header bg-white">
                                        <i class="fa fa-table"></i> Manage Category
                                    </div>
                                    <div class="card-block p-t-25">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            <thead>
												...
												<td><a href="<%=request.getContextPath() %>/CompanyManagecategoryController?categoryId=${i.categoryId}&flag=delete">Delete</a> / <a href="<%=request.getContextPath()%>/CompanyManagecategoryController?categoryId=${i.categoryId}&flag=update">Update</a> </td>

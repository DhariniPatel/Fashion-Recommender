...
<button class="btn without_border" type="button"><span class="fa fa-search">
            ...
            <ul id="menu" class="bg-blue dker">
                ...
                <!-- <li>
                    ...
                    <ul>
                        <li>
                            <a href="<%=request.getContextPath() %>/CompanyManagecategoryController?flag=View">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="<%=request.getContextPath()%>/CompanyManagesubcategoryController?flag=search">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="<%=request.getContextPath() %>/CompanyAddproductController?flag=loadCategory">
                                <i class="fa fa-angle-right"></i>
                                &nbsp; addProduct
                            </a>
                        </li>
                        <li>
                            <a href="<%=request.getContextPath() %>/CompanyAddproductController?flag=search">
                                <i class="fa fa-angle-right"></i>
                                &nbsp; SearchProduct
                            </a>
                        </li>
                ...
                <li>
                  ...
                  <!--   <li>
                    ...
                    <ul>
                        <li>
                            <a href="<%=request.getContextPath() %>/CompanyManageorderController?flag=search">
                                <i class="fa fa-angle-right"></i>
                                &nbsp; SearchManageorder
                            </a>
                        </li>

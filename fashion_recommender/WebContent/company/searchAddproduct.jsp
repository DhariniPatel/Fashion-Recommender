                                    ...
                                    <div class="card-block p-t-25">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <c:forEach items="${sessionScope.productlist}" var="i">
												...
												<td><a href="<%=request.getContextPath()%>/AddproductController?flag=delete&productId=${i.productId}">Delete</a> / <a href="<%=request.getContextPath()%>/AddproductController?flag=update&productId=${i.productId}">Update</a> </td>

...
z-index: 999999">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-block m-t-35">
                                        <form action="<%=request.getContextPath() %>/ManagesubcategoryController" method="post" form-horizontal  login_validator" id="form_block_validator">
 ...
 -->                                                    	<select name="categoryId" class="form-control">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="subcategoryName" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                ...
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="subcategoryDescription" class="form-control"></textarea>
                                                </div>
                                            </div>

...
<head>
    ...
    function fnload()
	{
		var sid=document.getElementById("countryId"); 
		...
		xmlhttp.open("get", "${pageContext.request.contextPath}/CityController?flag=loadCityAjax&countryId="+countryId.value, true);
		xmlhttp.send();
	}
...
z-index: 999999">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-block m-t-35">
                                        <form action="<%=request.getContextPath() %>/CityController" method="post" class="form-horizontal  login_validator" id="form_block_validator">
                                        
                                        	<div class="form-group row">
                                                <div class="col-lg-4  text-lg-right">
                                                    <label for="required2" class="form-control-label">Country Name</label>
                                                </div>
                                                <div class="col-lg-4">
                                                    <!-- <input type="text" id="required2" name="Name2" class="form-control" required>
 -->                                                    	<select name="countryId" id="countryId" class="form-control" onchange="fnload()">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-4  text-lg-right">
                                                    <label for="required2" class="form-control-label">State Name</label>
                                                </div>
                                                <div class="col-lg-4">
 ...
 -->                                                    	<select name="stateId" class="form-control" id="stateId">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="cityName" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                    <label  class="form-control-label">City Description</label>
                                                </div>
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="cityDescription" class="form-control"></textarea>
                                                </div>
                                            </div>

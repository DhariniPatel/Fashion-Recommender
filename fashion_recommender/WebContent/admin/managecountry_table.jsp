                            ...
                            <div class="col-xs-12 data_tables">
                                ...
                                <div class="card">
                                    <div class="card-header bg-white">
                                        <i class="fa fa-table"></i> Manage Country
                                    </div>
                                    <div class="card-block p-t-25">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <c:forEach items="${sessionScope.x}" var="i">
												<tr>
												<td>${i.countryId}</td>
												<td>${i.countryName}</td>
												<td>${i.countryDescription}</td>
												<td><a href="<%=request.getContextPath() %>/CountryController?countryId=${i.countryId}&flag=delete">Delete</a> / <a href="<%=request.getContextPath()%>/CountryController?countryId=${i.countryId}&flag=update">Update</a> </td>
                                            	<td>${i.status}</td>
                                            	</tr>

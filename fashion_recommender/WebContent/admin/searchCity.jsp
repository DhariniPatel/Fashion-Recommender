                            ...
                            <div class="col-xs-12 data_tables">
                                ...
                                <div class="card">
                                    <div class="card-header bg-white">
                                        <i class="fa fa-table"></i> Manage City
                                    </div>
                                    <div class="card-block p-t-25">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <c:forEach items="${sessionScope.citylist}" var="i">
												...
												<td><a href="<%=request.getContextPath() %>/CityController?cityId=${i.cityId}&flag=delete">Delete</a> / <a href="<%=request.getContextPath()%>/CityController?cityId=${i.cityId}&flag=update">Update</a> </td>

                            ...
                            <div class="col-xs-12 data_tables">
                                ...
                                <div class="card">
                                    <div class="card-header bg-white">
                                        <i class="fa fa-table"></i> Manage Complain
                                    </div>
                                    <div class="card-block p-t-25">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            <thead>
                                                ...
                                                <tbody><tr><td>payment related</td><td>sdfgh</td></tr><tr><td>123</td><td>qwaszx</td></tr><tr><td>product related</td><td>asdf</td></tr><tr><td>damage jeans</td><td>wertyuioplkl</td></tr><tr><td>product related</td><td>sdfghj</td></tr>
                                        </table>
                                    </div>
                                </div>

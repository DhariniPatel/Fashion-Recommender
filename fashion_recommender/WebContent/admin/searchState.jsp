                                    ...
                                    <div class="card-block p-t-25">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <c:forEach items="${sessionScope.statelist}" var="i">
												...
												<td><a href="<%=request.getContextPath() %>/StateController?stateId=${i.stateId}&flag=delete">Delete</a> / <a href="<%=request.getContextPath()%>/StateController?stateId=${i.stateId}&flag=update">Update</a> </td>

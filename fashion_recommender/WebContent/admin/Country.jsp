                                    ...
                                    <div class="card-block m-t-35">
                                        <form action="<%=request.getContextPath() %>/CountryController" method="post" class="form-horizontal  login_validator" id="form_block_validator">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="countryName" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                ...
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="countryDescription" class="form-control"></textarea>
                                                </div>
                                            </div>
                                                                                        
                                            <div class="form-actions form-group row">
                                                <div class="col-lg-4 push-lg-4">
                                                    <input type="submit" value="Submit" name="flag" class="btn btn-primary">
                                                </div>
                                            </div>
                                        </form>
                                    </div>

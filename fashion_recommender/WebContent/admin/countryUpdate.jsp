                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <c:forEach items="${sessionScope.y}" var="i" >
                                        <form action="<%=request.getContextPath() %>/CountryController" method="post" class="form-horizontal  login_validator" id="form_block_validator">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="countryName" value="${i.countryName}" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                    <label  class="form-control-label">Country Description</label>
                                                </div>
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="countryDescription" class="form-control">${i.countryDescription}</textarea>
                                                </div>
                                            </div>

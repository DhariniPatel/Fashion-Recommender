...
z-index: 999999">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <c:forEach items="${sessionScope.subcategorylist}" var="i" >
                                        <form action="<%=request.getContextPath() %>/ManagesubcategoryController" method="post" class="form-horizontal  login_validator" id="form_block_validator">
 ...
 -->                                                    	<select name="categoryId" class="form-control">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="subcategoryName" value="${i.subcategoryName}" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                    <label  class="form-control-label">SubCategory Description</label>
                                                </div>
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="subcategoryDescription" class="form-control">${i.subcategoryDescription}</textarea>
                                                </div>
                                            </div>

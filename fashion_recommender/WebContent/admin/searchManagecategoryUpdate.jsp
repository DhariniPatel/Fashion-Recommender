                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <c:forEach items="${sessionScope.clist}" var="i" >
                                        <form action="<%=request.getContextPath() %>/ManagecategoryController" method="post" class="form-horizontal  login_validator" id="form_block_validator">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="categoryName" value="${i.categoryName}" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                ...
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="categoryDescription" class="form-control">${i.categoryDescription}</textarea>
                                                </div>
                                            </div>

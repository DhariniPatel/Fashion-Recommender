                                    ...
                                    <div class="card-block p-t-25">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            <thead>
												...
												<td><a href="<%=request.getContextPath() %>/ManagecategoryController?categoryId=${i.categoryId}&flag=delete">Delete</a> / <a href="<%=request.getContextPath()%>/ManagecategoryController?categoryId=${i.categoryId}&flag=update">Update</a> </td>

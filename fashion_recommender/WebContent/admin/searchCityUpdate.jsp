...
z-index: 999999">
 ...
 -->                                                    	<select name="stateId" class="form-control">
 															<c:forEach items="${sessionScope.statelist}" var="k">						
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="cityName" value="${i.cityName}" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                ...
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="cityDescription" class="form-control">${i.cityDescription}</textarea>
                                                </div>
                                            </div>

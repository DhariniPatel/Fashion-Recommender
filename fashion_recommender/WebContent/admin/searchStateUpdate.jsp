...
z-index: 999999">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <c:forEach items="${sessionScope.statelist}" var="i" >
                                        <form action="<%=request.getContextPath() %>/StateController" method="post" class="form-horizontal  login_validator" id="form_block_validator">
 ...
 -->                                                    	<select name="countryId" class="form-control">
 															<c:forEach items="${sessionScope.clist}" var="j">						
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" id="required2" name="stateName" value="${i.stateName}" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-4 text-lg-right">
                                                    <label  class="form-control-label">State Description</label>
                                                </div>
                                                <div class="col-lg-4">
                                                    <textarea type="text"  name="stateDescription" class="form-control">${i.stateDescription}</textarea>
                                                </div>
                                            </div>

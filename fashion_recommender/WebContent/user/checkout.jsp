...
<!--<![endif]-->
    ...
    <meta data-browser="firefox" data-browser-major="51">
...
<meta id="shopify-digital-wallet" data-iframe-url="/16375229/digital_wallets/dialog" />
  ...
  <script src="js/checkout-eb9e00a603aca8437f60bb6ad6f7f35e81978b7362f99fa08995fea521e0e72c.js"></script>
    ...
    <meta name="shopify-checkout-authorization-token" content="7aac00a2e2aa022eebe663568fe7f81a" />

    
    
    <script src="js/countries-298a7ae4106e202cf3fb32b4a2853328727474b6-1482233444.js"></script>


  <script id="__st">
//<![CDATA[
var __st={"a":16375229,"offset":-14400,"reqid":"7d26a444-bba4-4247-bb64-64c95fc475cd","pageurl":"checkout.shopify.com\/16375229\/checkouts\/2285510df910426e168227da399d4440","u":"0e1071ec1f6a","t":"checkout","offsite":1};
//]]>
  ...
  <!--  <script src="https://checkout.stripe.com/checkout.js"
										...
										data-amount="500" data-name="Stripe.com"
  ...
  <div class="wrap">
    <div class="order-summary-toggle__inner">
      ...
      <div class="order-summary-toggle__total-recap total-recap" data-order-summary-section="toggle-total-recap">
        <span class="total-recap__final-price" data-checkout-payment-due-target="51000">$510.00</span>
...
<!--  <script src="https://checkout.stripe.com/checkout.js"
										class="stripe-button"
										data-key="pk_test_6pRNASCoBOKtIshFeQd4XMUh"
										data-amount="${j.totalamount}" data-name="Stripe.com"
										data-description="Widget"
										data-image="https://stripe.com/img/documentation/checkout/marketplace.png"
										data-locale="auto" data-zip-code="true">
</script>
-->
  ...
  <div class="order-summary__section__content">
    <table class="product-table">
      ...
      <tbody data-order-summary-section="line-items">
        <tr class="product" data-product-id="9097940428" data-variant-id="31530899660" data-product-type="Dress">
  ...
  <div class="product-thumbnail__wrapper">
    ...
    <span class="product-thumbnail__quantity" aria-hidden="true">4</span>
          ...
          <td class="product__price">
            <span class="order-summary__emphasis">$340.00</span>
          </td>
        </tr>
  ...
  <div class="product-thumbnail__wrapper">
    ...
    <span class="product-thumbnail__quantity" aria-hidden="true">2</span>
          ...
          <td class="product__price">
            <span class="order-summary__emphasis">$170.00</span>
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <tbody class="total-line-table__tbody">
        <tr class="total-line total-line--subtotal">
          ...
          <td class="total-line__price">
            <span class="order-summary__emphasis" data-checkout-subtotal-price-target="51000">
              $510.00
            </span>
          </td>
        </tr>
    ...
    <tfoot class="total-line-table__footer">
      <tr class="total-line">
        ...
        <td class="total-line__price payment-due">
          <span class="payment-due__currency">RS</span>
          <span class="payment-due__price" data-checkout-payment-due-target="51000">
            ${j.totalamount}
          </span>
        </td>
      </tr>
  ...
  <form novalidate="novalidate" class="edit_checkout" data-customer-information-form="true" action="<%=request.getContextPath() %>/CartController" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="patch" /><input type="hidden" name="authenticity_token" value="D9KFtXmOof94ozrqINhYCpzNcXWIgM+Oe7e5it95XhtOJ5NOnZHdT6wEi/tKgCJuqzdgPUVapqv/QolbN3v1uQ==" />
...
<div class="section section--contact-information">
    ...
    <div class="layout-flex layout-flex--tight-vertical layout-flex--loose-horizontal layout-flex--wrap">
      <h2 class="section__title layout-flex__item layout-flex__item--stretch">Customer information</h2>
       ...
       <!--  <p class="layout-flex__item">
          ...
          <a href="https://fashop-default.myshopify.com/account/login?checkout_url=https%3A%2F%2Fcheckout.shopify.com%2F16375229%2Fcheckouts%2F2285510df910426e168227da399d4440%3Fstep%3Dcontact_information">
  ...
  <div class="section__content">
          ...
          <div class="field field--required">
            ...
            <div class="field__input-wrapper field__input-wrapper--with-loader">
              <input placeholder="Email" autocapitalize="off" spellcheck="false" autocomplete="shipping email" data-autofocus="true" data-email-input="true" data-backup="customer_email" class="field__input" size="30" type="email" name="username" id="username" />
            </div>
</div>        </div> 
...
<input class="visually-hidden" autocomplete="shipping given-name" tabindex="-1" data-autocomplete-field="first_name" size="30" type="text" name="firstname" />
<div class="field--half field field--optional" data-address-field="first_name">
  ...
  <div class="field__input-wrapper">
    <input placeholder="First name" autocomplete="shipping given-name" data-backup="first_name" class="field__input" size="30" type="text" name="firstname" id="firstname" />
  </div>
</div>
<input class="visually-hidden" autocomplete="shipping family-name" tabindex="-1" data-autocomplete-field="last_name" size="30" type="text" name="lastname" />
<div class="field--half field field--required" data-address-field="last_name">
  ...
  <div class="field__input-wrapper">
    <input placeholder="Last name" autocomplete="shipping family-name" data-backup="last_name" class="field__input" size="30" type="text" name="lastname" id="lastname" />
  </div>
</div>

<input class="visually-hidden" autocomplete="shipping address-line1" tabindex="-1" data-autocomplete-field="address1" size="30" type="text" name="address" />
<div class="field--two-thirds field field--required" data-address-field="address1">
  ...
  <div class="field__input-wrapper">
    <input placeholder="Address" autocomplete="shipping address-line1" data-backup="address1" data-google-places="name" class="field__input" size="30" type="text" name="address" id="address" />
  </div>
</div>
...
<div data-address-field="city" class="field field--required">
  ...
  <div class="field__input-wrapper">
    <input placeholder="City" autocomplete="shipping address-level2" data-backup="city" data-google-places="locality" class="field__input" size="30" type="text" name="checkout[shipping_address][city]" id="checkout_shipping_address_city" />
  </div>
</div>
...
<div data-address-field="country" class="field--three-eights field field--required">
  ...
  <div class="field__input-wrapper field__input-wrapper--select">
    <select size="1" autocomplete="shipping country" data-backup="country" class="field__input field__input--select" name="checkout[shipping_address][country]" id="checkout_shipping_address_country"><option data-code="VN" value="Vietnam">Vietnam</option>
...
<div data-address-field="province" class="field--three-eights field field--required">
  ...
  <div class="field__input-wrapper field__input-wrapper--select">
    <input placeholder="State" autocomplete="shipping address-level1" data-backup="province" data-google-places="administrative_area_level_1" class="field__input" type="text" name="checkout[shipping_address][province]" id="checkout_shipping_address_province" />
  </div>
</div> -->
<input class="visually-hidden" autocomplete="shipping postal-code" tabindex="-1" data-autocomplete-field="zip" size="30" type="text" name="postcode" />
<div data-address-field="zip" class="field--quarter field field--required">
  ...
  <div class="field__input-wrapper">
    <input placeholder="110034" autocomplete="shipping postal-code" data-backup="zip" data-google-places="postal_code" class="field__input field__input--zip" size="30" type="text" name="postcode" id="postcode" />
  </div>
</div>

<div data-address-field="zip" class="field--quarter field field--required">
  <label class="field__label" for="checkout_shipping_address_zip">Grand Total</label>
  <div class="field__input-wrapper">
    <input class="field__input field__input--zip" size="30" value="${param.total}" type="text" name="GrandTotal" id="total" />
  </div>
</div>
      </div> 
    </div> 
...
<div class="step__footer">
  ...
  <button name="flag" type="submit" value="submit" class="step__footer__continue-btn btn ">
  <span class="btn__content">Continue to shipping method</span>
  <i class="btn__spinner icon icon--button-spinner"></i>
</button>
<!-- <a href="as.jsp">Payment</a>
  <a class="step__footer__previous-link" href="https://fashop-default.myshopify.com/cart"><svg class="icon-svg icon-svg--color-accent icon-svg--size-10 previous-link__icon rtl-flip" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10"><path d="M8 1L7 0 3 4 2 5l1 1 4 4 1-1-4-4"/></svg><span class="step__footer__previous-link-content">Return to cart</span></a> -->
</div>

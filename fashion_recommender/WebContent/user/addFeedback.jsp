...
<![endif]-->
  ...
  <meta property="og:title" content="Post Feedback">
...
<meta property="og:site_name" content="fashop-default">
  ...
  <title>Post Feedback &ndash; fashop-default</title>
...
<div class="container">				
  <!-- title -->
  <div class="title-box">
    <h1 class="text-center text-uppercase title-under">Post Feedback</h1>
  </div>
  <!-- /title -->		
  <div class="row">
    <section class="col-sm-12 col-md-6 col-lg-6col-sm-12 col-sm-offset-0  col-md-offset-3  col-lg-offset-3 col-xl-4 col-xl-offset-4">
      <div class="login-form-box">
        <div id="login">
          <h3 class="color small">Post Feedback</h3>
          <form method="post" action="<%=request.getContextPath() %>/FeedbackController" id="create_customer" accept-charset="UTF-8"><input type="hidden" value="create_customer" name="form_type" /><input type="hidden" name="utf8" value="✓" />
          <div class="form-group">
            <label for="feedback">Feedback <sup>*</sup></label>
            <input type="text" name="feedback" class="form-control" id="fname">
          </div>
